...
\citere{Gauld:2022lem} for instance, and we find that the by far dominant effect 
...
and with five-flavour scheme (5FS) predictions. As one can be observed in \fig{fig:bbZ}, the NNLO corrections are substantial and the necessary to describe LHC data.
...
With the work of \citere{Ebert:2024zdj}, we initiated the further extension of the \minnlo{} method by
...
We are currently developing an extension of the polarised diboson code, incorporating the effects of anomalous triple gauge boson couplings in terms of EFT operators~\cite{Chiesa:2018lcs} while maintaining NLO+PS accuracy.
%
