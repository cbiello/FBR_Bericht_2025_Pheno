...
\citere{Pelliccioli:2023zpd} presents a calcualtion and simulation
...
at the example of the Higgs transverse-momentum ($p_T$)
...
combination of VBF with the $H \to b\bar{b}$ decay channel particularly more
interesting.
...
In \citere{Liu:2023jkr}, we proposed a recipe for efficiently evaluating Feynman integrals through the auxiliary mass flow method and differential equations in the kinematic variable space.
...
In \citere{Wu:2023ntn}, we investigated several hidden-charm tetraquark systems using QCD sum rules and provided a possible explanation of the observed signals.
